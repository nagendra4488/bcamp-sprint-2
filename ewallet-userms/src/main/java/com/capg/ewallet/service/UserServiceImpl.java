...
public class UserServiceImpl implements UserService {
	...
	public WalletUser createWalletUser(WalletUser walletUser) throws UserAlreadyExistsException {
		...
		if (!(m1.find() && m1.group().equals(walletUser.getUserName()))) {
			throw new UserNameInvalidException(
					"Username should start with capital letter ad size should be 6-14  characters");

		} else if (!(m2.find() && m2.group().equals(walletUser.getPassword()))) {
			throw new UserPasswordInvalidException(
					"User password must contain " + "capital letter,small letters and special character "
	...
	@Override
	public WalletUser getUserDetails(int userId, String password) throws UserNotFoundException {
		// TODO Auto-generated method stub
