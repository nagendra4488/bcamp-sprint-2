...
public class UserController {
	...
	public WalletAccount getOneAccount(@PathVariable("id") int accountId) throws AccountNotFoundException {
	  ...
	  @GetMapping("/public/userid/{userId}/{password}")
	  public WalletUser getUser(@PathVariable int userId, @PathVariable String password) throws
	  UserNotFoundException {
		  WalletUser user =
	  userService.getUserDetails(userId,password);
