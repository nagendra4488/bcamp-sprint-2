...
public class AccountMsServiceImpl implements AccountMsService {
	 ...
	 * 
	 * @return WalletAccount : This returns the account an exception which is
	 *         handled globally
	 */

	/*
	 * @Transactional public WalletAccount addWalletAccount(WalletAccount
	 * walletAccount) throws AccountAlreadyExistsException, InvalidAmountException{
	 * // TODO Auto-generated method stub
	 * 
	 * if(accountMsRepo.existsById(walletAccount.getAccountId())) {
	 * 
	 * throw new
	 * AccountAlreadyExistsException("Account with id: "+walletAccount.getAccountId(
	 * ) +" Already Exist ");
	 * 
	 * } if(walletAccount.getAccountBalance()<0) {
	 * 
	 * throw new
	 * InvalidAmountException("Account Balance: "+walletAccount.getAccountBalance()+
	 * "Invalid");
	 * 
	...
	public WalletAccount addAmount(WalletAccount walletAccount)
		...
		WalletAccount userAccount = rt.getForObject(
				"http://localhost:8300/users/public/getaccount/id/" + walletAccount.getAccountId(),
				WalletAccount.class);
	...
	public WalletTransactionList getAllWalletTransaction() {
		...
		WalletTransactionList walletTransaction = rt.getForObject(
				"http://localhost:9000/transaction/public/getalltransaction", WalletTransactionList.class);
	 ...
	 * 
	 * @return List<WalletAccount> : This returns List of wallet Accounts an
	 *         exception which is handled globally
	 */
	 ...
	 * @return WalletAccount : This returns the WalletAccount an exception which is
	 *         handled globally
	 */
	@Override
	 ...
	 * @return List<WalletTransaction> : This returns the transaction details of
	 *         particular account by accountId
	 */
