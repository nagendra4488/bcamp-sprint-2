...
//	}
 ...
 WalletAccount fromAccount=rt.getForObject("http://localhost:8500/ewallet/users/getaccount/id/"+walletTransaction.getFromAccountId(),WalletAccount.class);
 WalletAccount toAccount=rt.getForObject("http://localhost:8500/ewallet/users/getaccount/id/"+walletTransaction.getToAccountId(),WalletAccount.class);
